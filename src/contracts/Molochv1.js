...
const MolochV1ABI = [
  ...
  },
  {
    ...
    outputs: [
      ...
      { name: "didPass", type: "bool" },
      { name: "aborted", type: "bool" },
      { name: "tokenTribute", type: "uint256" },
      { name: "details", type: "string" },
      { name: "maxTotalSharesAtYesVote", type: "uint256" },
    ],
    payable: false,
    stateMutability: "view",
    type: "function",
